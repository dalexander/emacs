...
(my-define-nv (kbd "ghq") 'kill-emacs)
...
(my-define-nv (kbd "ghph") (kbd "C-c C-c"))
(my-define-nv (kbd "ghpp") (kbd "C-c C-p"))
(my-define-nv (kbd "ghpr") (kbd "C-c C-r"))
(my-define-nv (kbd "ghpl") (kbd "0 v $ C-c C-r"))
(my-define-nv (kbd "ghpv") 'virtualenv-activate)
(my-define-nv (kbd "ghpc") (kbd "C-c C-v"))
(my-define-nv (kbd "ghpn") (kbd "C-c r r"))
